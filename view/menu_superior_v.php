                ...
                <div class="custom-dropdown cart-dropdown-content">
                    ...
                    <?php else: ?>
                        ...
                        <div class="cart-mini-total">
                            <strong>Total: <?php echo number_format($carrito_total_precio, 2); ?>€</strong>
                        </div>
...
<style>
/* CSS para asegurar que el hover funcione */
.dropdown-wrapper { position: relative; height: 100%; display: flex; align-items: center; }
.custom-dropdown { display: none; position: absolute; top: 100%; right: 0; background-color: white; min-width: 250px; box-shadow: 0 8px 16px rgba(0,0,0,0.15); border-radius: 8px; padding: 0.5rem 0; z-index: 1000; border: 1px solid #eee; }
.dropdown-wrapper:hover .custom-dropdown { display: block; }

.cart-dropdown-content { width: 300px; padding: 1rem; }
...
.item-name { flex: 1; white-space: nowrap; overflow: hidden; text-overflow: ellipsis; margin-right: 5px; }
...
.btn-checkout-mini:hover { background: #e85a2d; }
.cart-badge { background: #ff6b35; color: white; padding: 2px 8px; border-radius: 12px; font-size: 0.8rem; margin-left: 5px; font-weight: bold; }
